data<-read.csv("C:\\Users\\14483065\\Documents\\Bayesian\\datarisk2.csv")
map<-read.bnd("C:\\Users\\14483065\\Documents\\Bayesian\\nigeria.bnd")
d<-list(
...
### Response stunting and underweight
  OBS=c(data$stunting1,data$underweight1,data$wasting1),
  idx=N_idx
)
d.add=1E-4
